...
<p>
In the years since, atom interferometry has become one of the most active frontiers in precision measurement physics, with experiments like MAGIS at Stanford and AION at Oxford now explicitly targeting new-force searches and gravitational wave detection using atom interferometric techniques at the scales this paper discussed. The broader program of using quantum sensors to search for fundamental physics has grown enormously, though this paper's specific proposals have been largely superseded by the rapid development of the field.
</p>

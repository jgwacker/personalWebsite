...
<p>
The detected intensity at each point is the sum of two terms: the classical contribution (what you'd see if the two beams had no quantum relationship at all) plus an interference term whose amplitude is controlled by |γ|.
</p>

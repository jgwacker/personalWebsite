...
<div class="post-takeaway">The boundary between quantum and classical physics is not a wall; it's a dial you can turn.</div>

<div class="post-summary">
The Copenhagen interpretation taught generations of physicists that measurement is binary: you either observe a quantum system or you don't. A real experiment says otherwise. By smoothly tuning how much information a detector collects, physicists can watch interference patterns fade gradually from quantum to classical. The transition isn't a switch. It's a spectrum, and the math behind it is surprisingly simple.
</div>
...
<li>P. Kazemi et al., "Quantum carpets: a tool to observe decoherence," <em>New Journal of Physics</em> 15, 013052 (2013). <a href="https://doi.org/10.1088/1367-2630/15/1/013052">DOI</a> — proposes using spatiotemporal interference patterns to visualize decoherence in real time, including electrons near metal surfaces.</li>
